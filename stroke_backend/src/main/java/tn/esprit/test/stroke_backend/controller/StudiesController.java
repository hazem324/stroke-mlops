...
public class StudiesController {
        ...
        public ResponseEntity<Map<String, Object>> createStudy(@PathVariable Long patientId,
                        @Valid @RequestBody StudyRequest request) {

                try {

                        Studies study = studyService.createStudy(
                                        patientId,
                                        request);
        ...
        public ResponseEntity<Map<String, Object>> getPatientStudies(@PathVariable Long patientId) {
                ...
                try {
                        ...
                        List<Studies> studies = studyService.getPatientStudies(
                                        patientId);
        ...
        public ResponseEntity<Map<String, Object>> getStudy(@PathVariable Long studyId) {
                ...
                try {
                        ...
                        Studies study = studyService.getStudy(
                                        studyId);
        ...
        public ResponseEntity<?> getAnalysisHistory() {
                ...
                return studyService.getAnalysisHistory();
        }

        @PostMapping(value = "/{patientId}/analyze", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
        public ResponseEntity<?> analyzeStudy(@PathVariable Long patientId,
                        @RequestPart("file") MultipartFile file,
                        @RequestParam(value = "modality", defaultValue = "DWI") Modality modality) {
                log.info(
                                ...
                                file != null
                                                ...
                                                : null);
                try {
                        StudyResponseDTO response = studyService.analyzeStudy(
                                        patientId,
                                        file,
                                        modality);
